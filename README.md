...
**NOTE**
This maintenance of this library has move over to [userflynet](https://github.com/PhilipJovanovic/fhttp). The only use for this repository is so imports will not break.
